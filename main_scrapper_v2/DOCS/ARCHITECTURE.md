...
│   ├── groww/
│   │   ├── 2026-03-09.json     # Source daily file (descending order)
│   │   └── backup.json         # All-time archive for that source
│   ├── livemint/
│   ├── scanx/
│   ├── tradingview/
│   ├── zerodha/
...
│       └── 2026/
│           └── 03_March/
│               └── 2026-03-09.json  # Aggregated daily mirror
│
...
- Source daily files: `DATA/<source>/<YYYY-MM-DD>.json`
- Aggregated daywise files: `DATA/DAYWISE/YYYY/MM_MonthName/<YYYY-MM-DD>.json`
- Shared backup file: `DATA/backup.json` (all-time)
- URL-based deduplication within each source archive and source-aware dedup in the daywise mirror and shared backup
