...
DATA/
├── groww/
│   ├── 2026-03-07.json      ← Daily file: all Groww news from March 7
│   ├── 2026-03-08.json
│   ├── 2026-03-09.json
│   └── backup.json           ← All-time archive of every Groww article
├── livemint/
│   ├── 2026-02-15.json
│   ├── ...
│   ├── 2026-03-09.json
...
|-------|------|-------------|
| `source` | string | Source name (e.g., "groww") — added by API only |

### `backup.json`

Same schema as daily files but contains **all articles ever collected** for that source.
...
```bash
# Archive old backups
cp DATA/groww/backup.json DATA/groww/backup_2026_Q1.json
